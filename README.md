# UX Live Sticker Studio

Нативный редактор видеостикеров для Telegram: без Adobe, облака и командной строки.
...
![Стартовый экран UX Live Sticker Studio](docs/drop.png)

![Редактор UX Live Sticker Studio](docs/editor.png)
...
- **Обрезка 1:1** — итог всегда 512×512 (для видео крупнее 512px обрезка обязательна)
...
- **Быстрые команды**: Ctrl+O — новое видео, C — обрезка, B — удаление фона, Ctrl+E — экспорт, Ctrl+Z — отмена
